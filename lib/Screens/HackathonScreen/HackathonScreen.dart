...
class _HackathonPageState extends State<HackathonPage> {
  final HackathonsByIdBloc hackathonbyid = HackathonsByIdBloc();
  @override
  void initState() {
    hackathonbyid.add(HackathonInitialFetchEventById(widget.reqid));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: BlocConsumer<HackathonsByIdBloc, HackathonsState>(
          ...
          builder: (context, state) {
            switch (state.runtimeType) {
              case HackathonsByIdFetchingLoadingState:
              ...
              case HackathonsByIdFetchingSuccessfulState:
                final successState =
                    state as HackathonsByIdFetchingSuccessfulState;

                DateTime startDate = successState.hackathons.startDate;
                DateTime endDate = successState.hackathons.endDate;
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(
                                  successState.hackathons.imglink,
                                ),
                                fit: BoxFit.fill,
                              ),
                            ),
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        successState.hackathons.tags[index],
                                        style: TextStyle(
                                          fontFamily: "Mulish",
                                          color: kWhiteF7,
                                          fontSize:
                        ...
                        InkWell(
                          onTap: () {
                            appinfo.openExternalApplication(
                                successState.hackathons.website);
                          },
                          child: Padding(
                            padding: const EdgeInsets.symmetric(
                              horizontal: kPadding28,
                          ...
                          child: Row(
                            children: [
                              const Icon(
                                  ...
                                  color: kWhiteF7),
                              Text(
                                "Organizer : ${successState.hackathons.organizer}",
                                style: TextStyle(
                                  fontFamily: "Mulish",
                                  color: kWhiteF7,
                                  fontSize:
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                "Location : ${successState.hackathons.location}",
                                style: TextStyle(
                                  fontFamily: "Mulish",
                                  color: kWhiteF7,
                                  fontSize:
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              const Icon(Icons.group, color: kWhiteF7),
                              Text(
                                "Team Size : ${successState.hackathons.teamSize}",
                                style: TextStyle(
                                  fontFamily: "Mulish",
                                  color: kWhiteF7,
                                  fontSize:
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        successState.hackathons.sponsors[index],
                                        style: TextStyle(
                                          fontFamily: "Mulish",
                                          color: kWhiteF7,
                                          fontSize:
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                successState.hackathons.eligibility,
                                style: TextStyle(
                                  fontFamily: "Mulish",
                                  color: Colors.white.withOpacity(0.6),
                                  fontSize:
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                successState.hackathons.judgingCriteria,
                                style: TextStyle(
                                  fontFamily: "Mulish",
                                  color: Colors.white.withOpacity(0.6),
                                  fontSize:
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                successState.hackathons.schedule,
                                style: TextStyle(
                                  fontFamily: "Mulish",
                                  color: Colors.white.withOpacity(0.6),
                                  fontSize:
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                successState.hackathons.additionalInfo,
                                style: TextStyle(
                                  fontFamily: "Mulish",
                                  color: Colors.white.withOpacity(0.6),
                                  fontSize:
                        ...
                        Padding(
                          ...
                          child: Text(
                            successState.hackathons.description,
                            style: TextStyle(
                              fontFamily: "Mulish",
                              color: Colors.white.withOpacity(0.6),
                              fontSize:
                            ...
                            child: Padding(
                              ...
                              child: Column(children: [
                                Column(
                                  children: [
                                    Text(
                                      "Contact Email : ${successState.hackathons.contactEmail}",
                                      maxLines: 2,
                                      style: TextStyle(
                                        fontFamily: "Mulish",
                                        color: kWhiteF7,
