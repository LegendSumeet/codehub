...
import '../bloc/hackathonsbyid_bloc.dart';

var client = http.Client();

class HackathonsByIdRepo {
  static Future<Hacakthonbyid> fetchhackathonsbyid(String id) async {
    try {
      ...
      var response = await http.get(
        Uri.parse(
            "https://apicodehub.vercel.app/api/hackathons/gethackathon/$id"),
        headers: requestHeaders,
      );
      if (response.statusCode == 200) {
        Hacakthonbyid bootcampsdata = hacakthonbyidFromJson(response.body);
